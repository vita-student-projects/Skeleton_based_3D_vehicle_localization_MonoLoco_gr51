...
def preprocess_monoloco(keypoints, kk, zero_center=False):
    ...
    keypoints = torch tensors of (m, 3, 24)  or list [3,24]
    Outputs =  torch tensors of (m, 48) in meters normalized (z=1) and zero-centered using the center of the box
    """
